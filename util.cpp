 ...
 */
State state = WAITING_FOR_ACCESS;
...
//                 { "potwierdzenie", ACK}, {"prośbę o sekcję krytyczną", REQUEST_CRITICAL}, {"zwolnienie sekcji krytycznej", RELEASE} };
...
void inicjuj_typ_pakietu()
{
    ...
    */
    ...
    offsets[3] = offsetof(packet_t, requestTs);
...
void incrementLamportClock(int currentLamport){
    pthread_mutex_lock(&lamportMut);
    if(currentLamport > lamport)
