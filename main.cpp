...
int ackCount = 0;
int partsNeededModulo = 0;
// int partsAvailable = 1000;
...
{
    int partsAvailable = atoi(argv[1]);
    partsNeededModulo = atoi(argv[2]);
    MPI_Status status;
    int provided;
    ...
    Constructor* constructor = new Constructor(rank, partsAvailable);
    pthread_create( &threadKom, NULL, startKomWatek , constructor);
